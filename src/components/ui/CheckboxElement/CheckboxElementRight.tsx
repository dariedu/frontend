...
export const CheckboxElementRight: React.FC<TCheckElementProps> = ({
  ...
  return (
    checked ? (
      ...
      {children}
      <Checkbox.Root className="bg-light-gray-1 rounded-full w-6 h-6 flex justify-center items-center mr-4" onClick={()=>{onClickFunc(obj)}} defaultChecked>
        <Checkbox.Indicator  >
      ...
      <div className="flex justify-between w-[315px] items-center text-light-gray-5 " >
      {children}
      <Checkbox.Root className="bg-light-gray-1 rounded-full w-6 h-6 flex justify-center items-center mr-4" onClick={()=>{onClickFunc(obj)}}>
        <Checkbox.Indicator  >
          <CheckIcon className="text-light-gray-white font-bold rounded-full w-6 h-6 bg-light-brand-green"/>
        </Checkbox.Indicator>
      </Checkbox.Root>
