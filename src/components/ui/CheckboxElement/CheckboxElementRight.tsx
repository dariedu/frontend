...
export const CheckboxElementRight: React.FC<TCheckElementProps> = ({
  ...
  return (
    checked ? (
      ...
      {children}
      <Checkbox.Root className="bg-light-gray-1 rounded-full w-6 h-6 flex justify-center items-center mr-4  dark:bg-light-gray-5" onClick={()=>{onClickFunc(obj)}} defaultChecked>
        <Checkbox.Indicator  >
      ...
      {children}
      <Checkbox.Root className="bg-light-gray-1 rounded-full w-6 h-6 flex justify-center items-center mr-4 dark:bg-light-gray-5" onClick={()=>{onClickFunc(obj)}}>
        <Checkbox.Indicator  >
          <CheckIcon className="text-light-gray-white font-bold rounded-full w-6 h-6 bg-light-brand-green"/>
        </Checkbox.Indicator>
      </Checkbox.Root>
