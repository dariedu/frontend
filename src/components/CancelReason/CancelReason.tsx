...
function handleFormFieldChange(fieldName: TReasons, value: string) {
  ...
  return (
    <>
      <div className="w-[360px] h-fit flex flex-col rounded-t-2xl mt-2">
        <p>Причина отмены?</p>
        <Form.Root className="mt-[29px]" onSubmit={(e) => { e.preventDefault(); console.log("submited")}}>
          <div>
          <Form.Field name="reason1" className="mt-4">
            <Form.Label></Form.Label>
              <Form.Control asChild >
                <TextareaAutosize maxRows={5} className="w-[328px] bg-light-gray-1 h-max min-h-[68px] rounded-2xl py-4 px-3 text-light-gray-8-text font-gerbera-sub2
  placeholder:text-light-gray-3"
            ...
            <Form.Message match="valueMissing"  className="font-gerbera-sub2 text-light-error-red ">Пожалуйста, введите хотя бы одну причину</Form.Message>
          </Form.Field>
          <Form.Field name="reason2" className="mt-4">
            <Form.Label></Form.Label>
            <Form.Control asChild>
            <TextareaAutosize maxRows={5} className="w-[328px] bg-light-gray-1 min-h-[68px] rounded-2xl py-4 px-3 text-light-gray-8-text font-gerbera-sub2
