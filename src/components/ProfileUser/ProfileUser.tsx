...
const ProfileUser: React.FC<IProfileUserProps> = ({
  ...
  return (currentUser && (
    <div className="fixed pb-10 z-50 top-0 bg-light-gray-1  dark:bg-light-gray-black rounded-[16px] shadow-lg w-full max-w-[500px] max-h-[100vh] flex flex-col overflow-x-hidden">
